\section{Specific charge of the electron}
\label{electron}
...
\framebox{\parbox{\textwidth}{{\bf Caution}: High voltage is used in this experiment.  Complete all assembly steps before plugging in or turning on the power supply.}}\\
